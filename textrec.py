# USAGE
# python text recognition.py --east frozen east text detection.pb --image images /example 01.jpg
# python text recognition.py --east frozen east text detection.pb --image images/example 04.jpg --padding 0.05
